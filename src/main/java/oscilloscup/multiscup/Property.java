...
public abstract class Property<E> {
	...
	static Set<Class> acceptedTypes = new HashSet<>(Arrays.asList(byte.class, Byte.class, int.class, Integer.class,
			long.class, Long.class, double.class, Double.class, Float.class, float.class, Short.class, short.class));
	...
	public static <E> Set<Set<Property<E>>> findPropertyByUnitAndClock(List<Property<E>> props) {
		Map<String, Set<Property<E>>> m = new HashMap<>();

		for (Property<E> p : props) {
			String hash = p.getClock().hashCode() + ":" + (p.getUnit() == null ? "" : p.getUnit().hashCode());
	...
	public static <E> Property<E> findPropertyByName(List<Property<E>> props, String propertyName) {
		for (Property<E> p : props) {
	...
	public static <E> void addProperty(List<Property<E>> props, Property<E> p) {
		if (getNames(props).contains(p.name))
			throw new IllegalArgumentException("property " + p.getName() + " is already in");
